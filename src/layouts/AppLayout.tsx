...
export default function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#fbfcff] text-slate-950">
      ...
      <main tabIndex={-1} className="mx-auto max-w-5xl px-5 pb-52 pt-2 outline-none">
        <Outlet />
      </main>

      <nav className="app-main-bottom-nav fixed inset-x-0 bottom-0 z-50 border-t border-slate-200/80 bg-white/96 px-2 pb-[max(12px,env(safe-area-inset-bottom))] pt-2 shadow-[0_-10px_30px_rgba(15,23,42,0.08)] backdrop-blur-2xl">
